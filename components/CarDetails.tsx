              ...
              >
                <DialogPanel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                  ...
                  <div className="flex flex-1 flex-col gap-3">
                    <div className="relative w-full h-40 bg-slate-200 rounded-lg">
                      <Image
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {Object.entries(car).map(([key, value], index) => (
                        <div
                          className={`flex justify-between gap-5 w-full text-right p-2 rounded-md ${
                            index % 2 == 0 ? "bg-slate-200" : ""
                          }`}
                          key={key}
                        >
                          <h4 className="text-gray capitalize font-medium">
                            {key.split("_").join(" ")}
                          </h4>
